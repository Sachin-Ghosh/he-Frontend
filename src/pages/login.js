...
export default function Login() {
  ...
  if (session) {
    return (
      ...
      <button className='mx-16 my-16 flex items-center btn btn-ghost normal-case text-xl text-primary border-white' onClick={()=>{signOut('google');}}>Logout</button>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen flex items-stretch text-white">
      ...
      {/* Left Section */}
      <div className="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center" style={{backgroundImage: "url()"}}>
                <div className="absolute bg-black opacity-60 inset-0 z-0"></div>
                <div className="w-full px-24 z-10">
                    <h1 className="text-5xl font-bold text-left tracking-wide"><span className='bg-[url(/images/banner-1.jpeg)] '>Welcome Back!!!!</span></h1>
                    <p className="text-4xl my-4">We are always Here to <span className='blue_gradient'>Help Yoi</span></p>
                </div>
      ...
      <div className="absolute bg-black opacity-60 inset-0 z-0"></div>
        ...
        <div className="w-full px-24 z-10">
          <div className="text-right mb-10">
            <h1 className="text-5xl tracking-wide font-semibold mb-4 text-transparent bg-[url(/images/banner-1.jpeg)] bg-clip-text">Log In</h1>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              ...
              <button type="submit" onClick={()=>{signIn('google')}} className='w-full my-5 px-4 py-3 rounded-lg bg-blue-600 text-gray-200 font-semibold hover:bg-blue-500 transition-colors'>
              <Image src="/public/google.svg" width={10} height={10}/> Sign in with Google
              </button>
            </div>
          </form>
